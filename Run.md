...
--------------------------------------------------------
工厂方法设计模式：定义了一个创建对象的接口，但是由子类来决定要实例化的类是哪一个。工厂方法让；类把实例化推迟到子类。
...
**工厂方法与抽象工厂都是负责创建对象，但是工厂方法用的是继承，而 抽象工厂是组合**
...
### 说明
来源于：https://www.wickedlysmart.com/headfirstdesignpatterns/README.txt
